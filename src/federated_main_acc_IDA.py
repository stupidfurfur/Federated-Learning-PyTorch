...
from utils import get_dataset, average_weights_IDA, exp_details
...
if __name__ == '__main__':
    ...
    global_epoch_acc = []
    global_epoch_loss = []
    global_weights = [0] * int(args.frac * args.num_users)
    for epoch in tqdm(range(args.epochs)):
        ...
        global_weights = average_weights_IDA(local_weights)
    ...
    file_name = 'D:/DSlab/113_1/Ai/Federated-Learning-PyTorch-master/save/objects/{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_{:.2f}_{:.2f}_IDA.pkl'.\
        format(args.dataset, args.model, args.epochs, args.frac, args.iid,
               args.local_ep, args.local_bs,train_accuracy_number,test_acc_number)
    with open(f'{args.dataset}_{args.model}_{args.epochs}_C[{args.frac}]_iid[{args.iid}]_E[{args.local_ep}]_B[{args.local_bs}]_{train_accuracy_number:.2f}_{test_acc_number:.2f}_IDA_acc.txt', 'w') as file:
        # Loop through the list and write each item on a new line
        for item in global_epoch_acc:
            file.write(str(item) + '\n')
    with open(f'{args.dataset}_{args.model}_{args.epochs}_C[{args.frac}]_iid[{args.iid}]_E[{args.local_ep}]_B[{args.local_bs}]_{train_accuracy_number:.2f}_{test_acc_number:.2f}_IDA_loss.txt', 'w') as file:
        # Loop through the list and write each item on a new line
    ...
    plt.savefig('D:/DSlab/113_1/Ai/Federated-Learning-PyTorch-master/save/fed_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_{:.2f}_{:.2f}_loss_IDA.png'.
    ...
    plt.xlabel('Communication Rounds')
    plt.savefig('D:/DSlab/113_1/Ai/Federated-Learning-PyTorch-master/save/fed_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_{:.2f}_{:.2f}_acc_IDA.png'.
                format(args.dataset, args.model, args.epochs, args.frac,
                       args.iid, args.local_ep, args.local_bs,train_accuracy_number,test_acc_number))
