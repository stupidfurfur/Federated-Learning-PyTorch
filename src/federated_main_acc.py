...
from utils import get_dataset, average_weights_acc, exp_details
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        global_weights = average_weights_acc(local_weights,local_acc_list)
    ...
    file_name = 'D:/DSlab/113_1/Ai/Federated-Learning-PyTorch-master/save/objects/{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_{:.2f}_{:.2f}_ACC.pkl'.\
        format(args.dataset, args.model, args.epochs, args.frac, args.iid,
               args.local_ep, args.local_bs,train_accuracy_number,test_acc_number)
    with open(f'{args.dataset}_{args.model}_{args.epochs}_C[{args.frac}]_iid[{args.iid}]_E[{args.local_ep}]_B[{args.local_bs}]_{train_accuracy_number:.2f}_{test_acc_number:.2f}_ACC_acc.txt', 'w') as file:
        # Loop through the list and write each item on a new line
        for item in global_epoch_acc:
            file.write(str(item) + '\n')  # Adding '\n' for a new line after each item
    with open(f'{args.dataset}_{args.model}_{args.epochs}_C[{args.frac}]_iid[{args.iid}]_E[{args.local_ep}]_B[{args.local_bs}]_{train_accuracy_number:.2f}_{test_acc_number:.2f}_ACC_loss.txt', 'w') as file:
    ...
    plt.savefig('D:/DSlab/113_1/Ai/Federated-Learning-PyTorch-master/save/fed_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_{:.2f}_{:.2f}_loss_ACC.png'.
    ...
    plt.xlabel('Communication Rounds')
    plt.savefig('D:/DSlab/113_1/Ai/Federated-Learning-PyTorch-master/save/fed_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_{:.2f}_{:.2f}_acc_ACC.png'.
                format(args.dataset, args.model, args.epochs, args.frac,
                       args.iid, args.local_ep, args.local_bs,train_accuracy_number,test_acc_number))
